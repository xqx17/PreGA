...
typedef struct
{
    BIG_256_29 g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP_F25519;


/* Field Params - see rom.c */
extern const BIG_256_29 Modulus_F25519;	/**< Actual Modulus set in rom_field_yyy.c */
extern const BIG_256_29 ROI_F25519;	    /**< Root of unity set in rom_field_yyy.c */
extern const BIG_256_29 R2modp_F25519;	/**< Montgomery constant */
extern const BIG_256_29 CRu_F25519;       /**< Cube Root of Unity */
extern const BIG_256_29 SQRTm3_F25519; /**< Square root of -3 */
extern const BIG_256_29 TWK_F25519; /**< Tweak for square roots, pre-calculated from field norm */
...
#define TBITS_F25519 (MBITS_F25519%BASEBITS_256_29)           /**< Number of active bits in top word */
 ...
 */
extern void FP_F25519_rcopy(FP_F25519 *y, const BIG_256_29 x);
 ...
 *
	...
	@param y FP result
 */
extern void FP_F25519_nres(FP_F25519 *y, BIG_256_29 x);
/**	@brief Converts from residue form back to BIG integer form
 *
	@param y FP number to be converted to BIG
	@param x BIG result
 */
extern void FP_F25519_redc(BIG_256_29 x, FP_F25519 *y);
 ...
 */
extern void FP_F25519_mod(BIG_256_29 r, DBIG_256_29 d);

#ifdef FUSED_MODMUL
extern void FP_F25519_modmul(BIG_256_29, BIG_256_29, BIG_256_29);
#endif
 ...
 */
extern void FP_F25519_pow(FP_F25519 *x, FP_F25519 *y, BIG_256_29 z);
