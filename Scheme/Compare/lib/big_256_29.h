...
#define BIGBITS_256_29 (8*MODBYTES_256_29) /**< Length in bits */
#define NLEN_256_29 (1+((8*MODBYTES_256_29-1)/BASEBITS_256_29)) /**< length in bytes */
#define DNLEN_256_29 2*NLEN_256_29 /**< Double length in bytes */
#define BMASK_256_29 (((chunk)1<<BASEBITS_256_29)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_256_29 (1<<(CHUNK-BASEBITS_256_29-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_256_29 (BASEBITS_256_29/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_256_29 (((chunk)1<<HBITS_256_29)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_256_29 NLEN_256_29
#define MNV_256_29 (NLEN_256_29+1)
typedef chunk BIG_256_29[NLEN_256_29 + 2]; /**< Define type BIG as array of chunks */
#define DMPV_256_29 DNLEN_256_29
#define DMNV_256_29 (DNLEN_256_29+1)
typedef chunk DBIG_256_29[DNLEN_256_29 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG_256_29[NLEN_256_29];     /**< Define type BIG as array of chunks */
typedef chunk DBIG_256_29[DNLEN_256_29];   /**< Define type DBIG as array of chunks */
#endif
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_256_29_cswap(volatile BIG_256_29 x, volatile BIG_256_29 y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_256_29_cmove(volatile BIG_256_29 x, BIG_256_29 y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_256_29_dcmove(volatile BIG_256_29 x, BIG_256_29 y, int s);
/**	@brief Convert from BIG number to byte array (Constant Time)
 *
	@param a byte array
	@param x BIG number
 */
extern void BIG_256_29_toBytes(char *a, BIG_256_29 x);
/**	@brief Convert to BIG number from byte array (Constant Time)
 *
	@param x BIG number
	@param a byte array
 */
extern void BIG_256_29_fromBytes(BIG_256_29 x, char *a);
 ...
 */
extern void BIG_256_29_fromBytesLen(BIG_256_29 x, char *a, int s);
 ...
 *
   ...
   @param s byte array length
 */
extern void BIG_256_29_dfromBytesLen(DBIG_256_29 x, char *a, int s);
/**	@brief Outputs a DBIG number to the console (Variable Time)
 *
	@param x a DBIG number
 */
extern void BIG_256_29_doutput(DBIG_256_29 x);

/**	@brief Outputs a DBIG number to the console (Variable Time)
 *
	@param x a DBIG number
 */
extern void BIG_256_29_drawoutput(DBIG_256_29 x);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_29_add(BIG_256_29 x, BIG_256_29 y, BIG_256_29 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_29_or(BIG_256_29 x, BIG_256_29 y, BIG_256_29 z);
 ...
 *
	...
	@param i integer
 */
extern void BIG_256_29_inc(BIG_256_29 x, int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_29_sub(BIG_256_29 x, BIG_256_29 y, BIG_256_29 z);
/**	@brief Decrement BIG by a small integer - output not normalised (Constant Time)
 *
	@param x BIG number to be decremented
	@param i integer
 */
extern void BIG_256_29_dec(BIG_256_29 x, int i);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_256_29_dadd(DBIG_256_29 x, DBIG_256_29 y, DBIG_256_29 z);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_256_29_dsub(DBIG_256_29 x, DBIG_256_29 y, DBIG_256_29 z);
 ...
 */
extern void BIG_256_29_imul(BIG_256_29 x, BIG_256_29 y, int i);
 ...
 */
extern chunk BIG_256_29_pmul(BIG_256_29 x, BIG_256_29 y, int i);
/**	@brief Divide BIG by 3 - output normalised (Constant Time)
 *
	@param x BIG number
	@return Remainder
 */
extern int BIG_256_29_div3(BIG_256_29 x);
 ...
 *
	...
	@param i small integer
 */
extern void BIG_256_29_pxmul(DBIG_256_29 x, BIG_256_29 y, int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_29_mul(DBIG_256_29 x, BIG_256_29 y, BIG_256_29 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_29_smul(BIG_256_29 x, BIG_256_29 y, BIG_256_29 z);
 ...
 */
extern void BIG_256_29_sqr(DBIG_256_29 x, BIG_256_29 y);
 ...
 */
extern void BIG_256_29_monty(BIG_256_29 a, BIG_256_29 md, chunk MC, DBIG_256_29 d);
 ...
 */
extern void BIG_256_29_shl(BIG_256_29 x, int s);
 ...
 */
extern int BIG_256_29_fshl(BIG_256_29 x, int s);
 ...
 *
	...
	@return sign of r
 */
extern int BIG_256_29_ssn(BIG_256_29 r, BIG_256_29 a, BIG_256_29 m);
 ...
 */
extern chunk BIG_256_29_split(BIG_256_29 x, BIG_256_29 y, DBIG_256_29 z, int s);
 ...
 */
extern chunk BIG_256_29_norm(BIG_256_29 x);
 ...
 */
extern void BIG_256_29_dnorm(DBIG_256_29 x);
 ...
 */
extern int BIG_256_29_comp(BIG_256_29 x, BIG_256_29 y);
 ...
 */
extern void BIG_256_29_ctmod(BIG_256_29 x, BIG_256_29 n, int bd);
 ...
 */
extern void BIG_256_29_ctdmod(BIG_256_29 x, DBIG_256_29 y, BIG_256_29 n, int bd);
 ...
 *
    ...
    @param bd non-negative bit difference between maximum x and n
 */
extern void BIG_256_29_ctsdiv(BIG_256_29 x,BIG_256_29 n,int bd);
 ...
 *
    ...
    @param bd non-negative bit difference between maximum y and n
 */
extern void BIG_256_29_ctddiv(BIG_256_29 x, DBIG_256_29 y, BIG_256_29 n,int bd);
 ...
 *
	...
	@param n The modulus
 */
extern void BIG_256_29_mod(BIG_256_29 x, BIG_256_29 n); 
 ...
 *
	...
	@param n The Divisor
 */
extern void BIG_256_29_sdiv(BIG_256_29 x, BIG_256_29 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_256_29_dmod(BIG_256_29 x, DBIG_256_29 y, BIG_256_29 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_256_29_ddiv(BIG_256_29 x, DBIG_256_29 y, BIG_256_29 n);
/**	@brief  return parity of BIG, that is the least significant bit (Constant Time)
 *
	@param x BIG number
	@return 0 or 1
 */
extern int BIG_256_29_parity(BIG_256_29 x);
 ...
 *
	...
	@return 0 or 1
 */
extern int BIG_256_29_bit(BIG_256_29 x, int i);
 ...
 */
extern int BIG_256_29_lastbits(BIG_256_29 x, int n);
 ...
 */
extern void BIG_256_29_random(BIG_256_29 x, csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_256_29_randomnum(BIG_256_29 x, BIG_256_29 n, csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_256_29_randtrunc(BIG_256_29 x, BIG_256_29 n, int t, csprng *r);
 ...
 */
extern void BIG_256_29_modmul(BIG_256_29 x, BIG_256_29 y, BIG_256_29 z, BIG_256_29 n);
/**	@brief  Calculate x=y/z mod n (Variable Time)
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_29_moddiv(BIG_256_29 x, BIG_256_29 y, BIG_256_29 z, BIG_256_29 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_29_modsqr(BIG_256_29 x, BIG_256_29 y, BIG_256_29 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_29_modneg(BIG_256_29 x, BIG_256_29 y, BIG_256_29 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_29_modadd(BIG_256_29 x, BIG_256_29 y, BIG_256_29 z, BIG_256_29 n);
 ...
 */
extern int BIG_256_29_jacobi(BIG_256_29 x, BIG_256_29 y);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_29_invmodp(BIG_256_29 x, BIG_256_29 y, BIG_256_29 n);
...
*/
extern void BIG_256_29_mod2m(BIG_256_29 x, int m);
...
static inline chunk muladd_256_29(chunk x, chunk y, chunk c, chunk *r)
{
    dchunk prod = (dchunk)x * y + c + *r;
    *r = (chunk)prod & BMASK_256_29;
    return (chunk)(prod >> BASEBITS_256_29);
}
