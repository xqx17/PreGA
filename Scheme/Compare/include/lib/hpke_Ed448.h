 ...
 */
extern int DeriveKeyPair_Ed448(int config_id,octet *SK,octet *PK,octet *SEED);
 ...
 */
extern void HPKE_Ed448_Encap(int config_id,octet *SK,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_Ed448_Decap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_Ed448_AuthEncap(int config_id,octet *skE,octet *skS,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 *
    ...
    @param pkS the Initiators public key
 */
extern void HPKE_Ed448_AuthDecap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 */
extern void HPKE_Ed448_KeySchedule(int config_id,octet *key,octet *nonce,octet *exp_secret,int mode,octet *Z,octet *info,octet *psk,octet *pskID);
