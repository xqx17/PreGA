...
extern const BIG_256_28 Modulus_NIST256;	/**< Actual Modulus set in rom_field_yyy.c */
extern const BIG_256_28 ROI_NIST256;	    /**< Root of unity set in rom_field_yyy.c */
extern const BIG_256_28 R2modp_NIST256;	/**< Montgomery constant */
extern const BIG_256_28 CRu_NIST256;       /**< Cube Root of Unity */
extern const BIG_256_28 SQRTm3_NIST256; /**< Square root of -3 */
extern const BIG_256_28 TWK_NIST256; /**< Tweak for square roots, pre-calculated from field norm */
...
#define TBITS_NIST256 (MBITS_NIST256%BASEBITS_256_28)           /**< Number of active bits in top word */
 ...
 */
extern void FP_NIST256_rcopy(FP_NIST256 *y, const BIG_256_28 x);
 ...
 *
	...
	@param y FP result
 */
extern void FP_NIST256_nres(FP_NIST256 *y, BIG_256_28 x);
/**	@brief Converts from residue form back to BIG integer form
 *
	@param y FP number to be converted to BIG
	@param x BIG result
 */
extern void FP_NIST256_redc(BIG_256_28 x, FP_NIST256 *y);
 ...
 */
extern void FP_NIST256_mod(BIG_256_28 r, DBIG_256_28 d);

#ifdef FUSED_MODMUL
extern void FP_NIST256_modmul(BIG_256_28, BIG_256_28, BIG_256_28);
#endif
 ...
 */
extern void FP_NIST256_pow(FP_NIST256 *x, FP_NIST256 *y, BIG_256_28 z);
